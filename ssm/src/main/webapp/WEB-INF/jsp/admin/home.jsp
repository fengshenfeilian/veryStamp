...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        <li class="dash"><a href="/admin/home" class="active"><span>主页</span></a></li>
        <li class="tables"><a href="/admin/consumerManage"><span>用户管理</span></a></li>
        <li class="tables"><a href="/admin/shopManage"><span>商户管理</span></a></li>
