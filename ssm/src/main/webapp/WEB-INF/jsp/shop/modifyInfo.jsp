    ...
    <div class="wrapper">
        <div class="widget">
            <div class="title"><img src="/static/images/icons/dark/frames.png" alt="" class="titleIcon" />
                <h6>修改信息</h6></div>
            <form action="${pageContext.request.contextPath}/shop/modifyInfo" method="post" class="form">
                <fieldset>
                    <div class="formRow">
                        <label for="login">原密码</label>
                        <div class="loginInput"><input type="password" name="oldPassword" class="validate[required]" id="login" /></div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="loginInput"><input type="password" name="confirmPassword" class="validate[required]" id="pass" /></div>
                        <div class="clear"></div>
                    </div>

                    <div class="formRow">
                        <label for="pass">联系电话</label>
                        <div class="loginInput"><input type="text" name="phone" class="validate[required]" id="pass" /></div>
                        <div class="clear"></div>
                    </div>

                    <div class="formRow">
                        <label for="pass">联系地址</label>
                        <div class="loginInput"><input type="text" name="address" class="validate[required]" id="pass" /></div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        ...
                        <input type="time" name="businessStartTime"/>
                        <div class="clear"></div>
                    </div>

                    <div class="formRow">
                        <label style="width:10%">营业截止时间</label>
                        <input type="time" name="businessEndTime"/>
                        <div class="clear"></div>
                    </div>

                    <div class="loginControl">
                        <input type="submit" value="确定修改" class="dredB logMeIn" />
                        <div class="clear"></div>
                    </div>
                </fieldset>
            </form>
