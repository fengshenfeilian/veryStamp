...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="table"><a href="/admin/consumerManage" class="active"><span>用户管理</span></a></li>
        <li class="table"><a href="/admin/shopManage"><span>商户管理</span></a></li>
    ...
    <div class="wrapper">
        <div class="widget">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="display dTable" id="res1">
                <thead>
                <tr>
                    <td class="sortCol"><div>用户ID<span></span></div></td>
                    <td class="sortCol"><div>用户名<span></span></div></td>
                    <td class="sortCol"><div>地址<span></span></div></td>
                    <td class="sortCol"><div>电话号码<span></span></div></td>
                    <td class="sortCol"><div>选项<span></span></div></td>
                </tr>
                </thead>
                <tbody align="center">
                <c:forEach items="${consumerList}" var="studentCourse" varStatus="loop">
                    <tr>
                        <td>${consumerList[loop.count-1].consumerId}</td>
                        <td>${consumerList[loop.count-1].userName}</td>
                        <td>${consumerList[loop.count-1].address}</td>
                        <td>${consumerList[loop.count-1].phone}</td>
                        <%--
