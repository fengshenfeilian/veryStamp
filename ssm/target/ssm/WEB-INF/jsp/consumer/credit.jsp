...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="dash"><a href="/consumer/myOrder" title="" class=""><span>我的订单</span></a></li>
        <li class="dash"><a href="/consumer/showcredit" title="" class="active"><span>财务管理</span></a>
        </li>
    </ul>
</div>
        ...
        <div class="widget">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="display dTable" id="res1">
                ...
                <tr>
                    ...
                    <td class="sortCol"><div>交易金额<span></span></div></td>
                    <td class="sortCol"><div>消费时间<span></span></div></td>
