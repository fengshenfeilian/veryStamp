...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        <li class="tables"><a href="/user/registerPage" class="active"><span>用户注册</span></a></li>
        <li class="tables"><a href="/user/shopRegisterPage"><span>商户注册</span></a></li>
...
<div id="rightSide">
    ...
    <div class="wrapper">
        <div class="widget">
            <form  method="post" id="validate" class="form" action="${pageContext.request.contextPath}/user/consumerRegister" enctype="multipart/form-data">
                <%-- 邮箱号必须全局唯一 --%>
                <div class="formRow">
